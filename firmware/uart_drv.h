...
#define uart_set_baud(bd) (OCR1C = bd)
#define uart_reset_baud() (OCR1C = 0)

#define uart_start_timing() (TIMSK |= (1 << TOIE1)) //Enable TImer 1 Interrupt
#define uart_stop_timing() (TIMSK &= ~(1 << TOIE1))
